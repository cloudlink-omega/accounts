...
const (
	...
	USER_IS_OAUTH_ONLY       uint = 5 // If the sixth bit is set, the user can only log in using OAuth (passwordless login).
	USER_IS_TOTP_ENABLED     uint = 6 // If the seventh bit is set, the user has enabled TOTP on their account.
